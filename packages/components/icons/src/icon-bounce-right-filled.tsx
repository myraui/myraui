...
export const IconBounceRightFilled = createIcon({
  path: (
    <>
      ...
      />
      <path d="M18 4a3 3 0 1 0 0 6a3 3 0 0 0 0 -6z" fill="currentColor" style={{ strokeWidth: 'var(--myraui-icon-stroke-width, 0' }} />
    </>
  ),
  displayName: 'IconBounceRightFilled',
  viewBox: '0 0 24 24',
  defaultProps: {
    stroke: 'currentColor',
    fill: 'none',
