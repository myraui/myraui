...
export const IconBounceLeftFilled = createIcon({
  path: (
    <>
      ...
      />
      <path d="M6 4a3 3 0 1 0 0 6a3 3 0 0 0 0 -6z" fill="currentColor" style={{ strokeWidth: 'var(--myraui-icon-stroke-width, 0' }} />
    </>
  ),
  displayName: 'IconBounceLeftFilled',
  viewBox: '0 0 24 24',
  defaultProps: {
    stroke: 'currentColor',
    fill: 'none',
