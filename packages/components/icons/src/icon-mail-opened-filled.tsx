...
export const IconMailOpenedFilled = createIcon({
  path: (
    <>
      ...
      />
      <path d="M2 9.535l5.429 3.62l-5.429 5.43z" fill="currentColor" style={{ strokeWidth: 'var(--myraui-icon-stroke-width, 0' }} />
      <path d="M22 9.535v9.05l-5.43 -5.43z" fill="currentColor" style={{ strokeWidth: 'var(--myraui-icon-stroke-width, 0' }} />
      <path
  ...
  displayName: 'IconMailOpenedFilled',
  viewBox: '0 0 24 24',
  defaultProps: {
    stroke: 'currentColor',
    fill: 'none',
